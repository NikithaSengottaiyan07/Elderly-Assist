...
exports.ReactNativeSoundTTSProvider = void 0;
...
class ReactNativeSoundTTSProvider {
  ...
  playNext(linkedSrc) {
    this.audioPlayer = new _reactNativeSound.default(linkedSrc.src, "", error => {
      if (error) {
        return;
      }
      if (this.audioPlayer) {
...
exports.ReactNativeSoundTTSProvider = ReactNativeSoundTTSProvider;
