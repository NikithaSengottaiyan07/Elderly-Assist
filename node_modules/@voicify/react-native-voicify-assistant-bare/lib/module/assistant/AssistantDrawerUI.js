...
export const AssistantDrawerUI = props => {
  ...
  const [assistantIsListening, setAssistantIsListening] = useState();
  const [assistantState, setAssistantState] = useState(props.initializeWithWelcomeMessage ? "Conversation" : "Start");
  ...
  const [isRecoginzing, setIsRecognizing] = useState(false);
  const [inputType, setInputType] = useState(props.useVoiceInput && !props.initializeWithText ? 'Speech' : 'Text');
  const [isLandscape, setIsLandscape] = useState(false);
  const isRecognizingRef = useRef();
  const isKeyboardActiveRef = useRef();
  const isUsingSpeechRef = useRef();
  const assistantIsListeningRef = useRef();
  const messagesRef = useRef();
  const assistantStateRef = useRef();
  const shouldEndSessionRef = useRef();
  const scrollViewRef = useRef();
  const assistantHintsRef = useRef();
  ...
  return /*#__PURE__*/React.createElement(Modal, {
  ...
  }, assistantStateRef.current.includes('Conversation') && /*#__PURE__*/React.createElement(View, {
    style: {
      display: 'flex',
      flexDirection: 'column',
      flex: 1
  ...
  }, ((_props$header6 = props.header) === null || _props$header6 === void 0 ? void 0 : _props$header6.assistantImage) && /*#__PURE__*/React.createElement(View, {
    style: {
  ...
  }, (_props$header10 = props.header) === null || _props$header10 === void 0 ? void 0 : _props$header10.assistantName)), /*#__PURE__*/React.createElement(TouchableOpacity, {
    style: {
      borderRadius: 30,
      width: 30,
      height: 30,
    ...
    }, message.origin == 'Received' && ((_props$body11 = props.body) === null || _props$body11 === void 0 ? void 0 : _props$body11.assistantImage) && /*#__PURE__*/React.createElement(View, {
      style: {
        maxHeight: 30,
        maxWidth: 30,
  ...
  }, /*#__PURE__*/React.createElement(View, null, !assistantStateRef.current.includes('Conversation') && /*#__PURE__*/React.createElement(View, {
    style: {
      display: 'flex',
      flexDirection: 'row',
      justifyContent: 'space-between'
  ...
  }, (_props$toolBar10 = props.toolBar) === null || _props$toolBar10 === void 0 ? void 0 : _props$toolBar10.drawerWelcomeText), /*#__PURE__*/React.createElement(TouchableOpacity, {
    style: {
      borderRadius: 30,
      width: 30,
      height: 30
  ...
  }))), isUsingSpeechRef.current && /*#__PURE__*/React.createElement(View, null, /*#__PURE__*/React.createElement(SpeakingAnimation, {
  ...
  }), assistantIsListeningRef.current ? /*#__PURE__*/React.createElement(Text, {
    style: {
  ...
  }, "Listening...") : assistantStateRef.current == 'Understood' ? /*#__PURE__*/React.createElement(Text, {
    style: {
      alignSelf: 'flex-start',
  ...
  }, "Processing...") : assistantStateRef.current.includes('Try Again') ? /*#__PURE__*/React.createElement(Text, {
    style: {
      alignSelf: 'flex-start',
  ...
  }, "I didn't catch that...") : /*#__PURE__*/React.createElement(Text, null), /*#__PURE__*/React.createElement(View, {
    style: {
      borderWidth: 1,
      borderStyle: 'solid',
      borderColor: "#FFFFFF",
  ...
  }, spokenText))), assistantStateRef.current.includes('Conversation') && !isUsingSpeechRef.current ? /*#__PURE__*/React.createElement(View, null) : /*#__PURE__*/React.createElement(View, {
    style: {
      marginTop: 16,
      borderWidth: 0.6,
      borderStyle: 'dashed',
  ...
  }, props.useVoiceInput && /*#__PURE__*/React.createElement(View, {
    style: {
      display: 'flex',
      flexDirection: 'column',
      alignItems: 'center'
  ...
  }, "SPEAK"), /*#__PURE__*/React.createElement(View, {
    style: {
      borderRadius: 25,
      padding: 4,
  ...
  }, props.useVoiceInput && /*#__PURE__*/React.createElement(Text, {
    style: {
